...
/**
 * Operator Ternary
    Kamu dapat menulis statemen if..else dengan lebih sederhana menggunakan operator ternary. Dengan operator 
    ternary, Kamu dapat membuat sebuah kondisi hanya dengan satu baris saja.
